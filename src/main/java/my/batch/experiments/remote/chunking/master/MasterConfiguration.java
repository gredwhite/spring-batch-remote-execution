...
public class MasterConfiguration {
    ...
    private final Logger logger = LoggerFactory.getLogger(MasterConfiguration.class);
    @Value("${broker.url}")
...
//    @JmsListener(destination = "replies")
//    public void receiveOrder(ChunkResponse response) {
...
//    }
    ...
    public Job remoteChunkingJob() {
        return this.jobBuilderFactory.get("remoteChunkingJobNew")
